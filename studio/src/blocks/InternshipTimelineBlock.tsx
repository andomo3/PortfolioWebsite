import type { InternshipTimelineProps } from "../types/layout";

type Props = { props: InternshipTimelineProps };

export default function InternshipTimelineBlock({ props }: Props) {
  ...
  return (
    <div style={{ border: "1px solid rgba(0,0,0,0.08)", borderRadius: 16, padding: 16, background: "#fff" }}>
      ...
      <div style={{ display: "grid", gap: 10, marginTop: 12 }}>
        {items.length === 0 && <div style={{ fontSize: 12, opacity: 0.6 }}>Add timeline items.</div>}
