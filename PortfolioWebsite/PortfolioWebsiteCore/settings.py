...
SECRET_KEY = os.getenv("SECRET_KEY", "xeqqy6-gaBwuj-petgeh")
...
TEMPLATES = [
    {
        ...
        'DIRS': [str(BASE_DIR / 'templates')],  # allows for the base.html file to be located
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STORAGES = {
    # Use Cloudinary on Render, local filesystem in dev
    "default": {
...
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / "media"  # only used locally (dev)
